...
import io.bootify.davidtinaut_spring_batch_banco.service.TransaccionesService;
import io.bootify.davidtinaut_spring_batch_banco.util.WebUtils;
...
public class TransaccionesController {
    ...
    public void prepareContext(final Model model) {
        model.addAttribute("tipoValues", TipoTrans.values());
    }
