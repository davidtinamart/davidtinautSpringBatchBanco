# DavidtinautSpringBatchBanco

* Enlace a mi repositorio:https://github.com/davidtinamart/davidtinautSpringBatchBanco.git 
...
```
java -Dspring.profiles.active=production -jar ./target/davidtinautSpringBatchBanco-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/davidtinaut-spring-batch-banco
```
